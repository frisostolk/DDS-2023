...
def _load_data_to_db():
    ...
    with engine.connect() as conn:
        result = conn.execute(
            text(
                "DROP TABLE IF EXISTS population, area, nutrients, emissions, weather CASCADE; "
            )
        )
    ...
    agri_prod_cereals = pd.read_excel(
        "../data/agri_production/cereals.xlsx",
        "Sheet 1",
        header=8,
        usecols="A,B,D,F,H,J,L,N,P,R,T,V",
        skiprows=[9, 10, 11, 12],
        skipfooter=7,
        na_values=":",
    )
    agri_prod_cereals = agri_prod_cereals.rename(columns={"TIME": "Country"})
    agri_prod_cereals = agri_prod_cereals.melt(
        id_vars="Country", var_name="Year", value_name="Value"
    )
    agri_prod_cereals["Type"] = "Cereals"

    agri_prod_vegetables = pd.read_excel(
        "../data/agri_production/vegetables.xlsx",
        "Sheet 1",
        header=8,
        usecols="A,B,D,F,H,J,L,N,P,R,T,V",
        skiprows=[9, 10, 11, 12],
    ...
    agri_prod_vegetables = agri_prod_vegetables.melt(
        id_vars="Country", var_name="Year", value_name="Value"
    )
    agri_prod_vegetables["Type"] = "Vegetables"

    # Data set for dairy
    agri_prod_dairy = pd.read_excel(
        "../data/agri_production/dairy.xlsx",
        "Sheet 1",
        header=8,
        usecols="A,B,D,F,H,J,L,N,P,R,T",
        skiprows=[9, 10, 11, 12],
        skipfooter=9,
        na_values=":",
    )
    agri_prod_dairy = agri_prod_dairy.rename(columns={"TIME": "Country"})
    agri_prod_dairy = agri_prod_dairy.melt(
        id_vars="Country", var_name="Year", value_name="Value"
    )
    agri_prod_dairy["Type"] = "Dairy"

    # Data sets for meat production
    agri_prod_beef = pd.read_excel(
        "../data/agri_production/beef.xlsx",
        "Sheet 1",
        header=9,
        usecols="A,B,D,F,H,J,L,N,P,R,T",
        skiprows=[10, 11, 12, 13, 14, 15],
        skipfooter=7,
        na_values=":",
    )
    agri_prod_beef = agri_prod_beef.rename(columns={"TIME": "Country"})
    agri_prod_beef = agri_prod_beef.melt(
        id_vars="Country", var_name="Year", value_name="Value"
    )
    agri_prod_beef["Type"] = "Beef"

    agri_prod_mutton = pd.read_excel(
        "../data/agri_production/mutton.xlsx",
        "Sheet 1",
        header=9,
        usecols="A,B,D,F,H,J,L,N,P,R,T",
        skiprows=[10, 11, 12, 13, 14, 15],
    ...
    agri_prod_mutton = agri_prod_mutton.melt(
        id_vars="Country", var_name="Year", value_name="Value"
    )
    agri_prod_mutton["Type"] = "Mutton"

    agri_prod_pork = pd.read_excel(
        "../data/agri_production/pork.xlsx",
        "Sheet 1",
        header=9,
        usecols="A,B,D,F,H,J,L,N,P,R,T",
        skiprows=[10, 11, 12, 13, 14, 15],
    ...
    agri_prod_pork = agri_prod_pork.melt(
        id_vars="Country", var_name="Year", value_name="Value"
    )
    agri_prod_pork["Type"] = "Pork"

    # Data set for poultry production
    agri_prod_poultry = pd.read_excel(
        "../data/agri_production/poultry.xlsx",
        "Sheet 1",
        header=9,
        usecols="A,B,D,F,H,J,L,N,P,R,T",
        skiprows=[10, 11, 12, 13, 14, 15],
    ...
    agri_prod_poultry = agri_prod_poultry.melt(
        id_vars="Country", var_name="Year", value_name="Value"
    )
    ...
    agri_area = pd.read_excel(
        "../data/agri_area/general_area_2020.xlsx",
        "Sheet 1",
        header=11,
        usecols="A,B,D,F,H,J,L,N,P,R,T,V",
        skiprows=[12],
    ...
    agri_nut_nitrogen = pd.read_excel(
        "../data/agri_nutrients/nitrogen_per_hectare.xlsx",
        "Sheet 1",
        header=8,
        usecols="A,B,D,F,H,J,L,N,P,R,T",
        skiprows=[9, 10],
    ...
    agri_nut_nitrogen = agri_nut_nitrogen.melt(
        id_vars="Country", var_name="Year", value_name="Value"
    )
    agri_nut_nitrogen["Nutrient"] = "Nitrogen"

    agri_nut_phosphorus = pd.read_excel(
        "../data/agri_nutrients/phosphorus_per_hectare.xlsx",
        "Sheet 1",
        header=8,
        usecols="A,B,D,F,H,J,L,N,P,R,T",
        skiprows=[9, 10],
    ...
    agri_nut_phosphorus = agri_nut_phosphorus.melt(
        id_vars="Country", var_name="Year", value_name="Value"
    )
    ...
    agri_greenhouse_emissions = pd.read_excel(
        "../data/agri_emissions/greenhouse.xlsx",
        "Sheet 1",
        header=9,
        usecols="A,B,D,F,H,J,L,N,P,R,T",
        skiprows=[10, 11],
    ...
    agri_greenhouse_emissions = agri_greenhouse_emissions.rename(
        columns={"TIME": "Country"}
    )
    agri_greenhouse_emissions = agri_greenhouse_emissions.melt(
        id_vars="Country", var_name="Year", value_name="Value"
    )
    ...
    agri_greenhouse_emissions.to_sql(
        "emissions", engine, if_exists="replace", index=True
    )
